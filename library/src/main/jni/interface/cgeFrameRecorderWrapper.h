...
#include <jni.h>
/* Header for class io_github_sy_CGEFrameRecorder */

#ifndef _Included_io_github_sy_CGEFrameRecorder
#define _Included_io_github_sy_CGEFrameRecorder
...
JNIEXPORT void JNICALL Java_io_github_sy_CGEFrameRecorder_nativeSetTempDir
